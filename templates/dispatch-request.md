...
# Dispatch: <deliverable in one phrase>
...
- ✅ <decision, e.g. "Title: <exact title>">
- ✅ <decision, e.g. "Format/length: <spec>">
- ✅ <decision>
- ✅ <decision>
...
| Field | Value |
|---|---|
| <e.g. Resolution / word count / file format> | <exact value> |
| <e.g. Duration / page count> | <exact value> |
| <e.g. Source assets> | <absolute paths> |
| <e.g. Output location> | <absolute path or URL> |
| <e.g. Style/brand constraint> | <token, guide reference> |
