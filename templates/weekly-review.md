...
**Filled:** <YYYY-MM-DD> · **Prior review:** <path or "first one">

## Wins

<!-- 3-5, concrete, past tense. Shipped/sent/learned. Small counts. -->
...
|---|---|---|---|
| <who / what> | <YYYY-MM-DD> | <n> | <draft nudge / wait / close out> |
...
|---|---|---|---|
| <name> | <yes/no> | <what shipped / a number> | <dependency or "nothing"> |

## By the numbers

<!-- The 3-5 metrics you actually steer by. Same metrics every week. -->

- <metric>: <this week> (prior: <last week>)
- <metric>: <this week> (prior: <last week>)
